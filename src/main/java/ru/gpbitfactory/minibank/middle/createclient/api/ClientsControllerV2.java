...
import ru.gpbitfactory.minibank.middle.createclient.dto.CreateClientRequestV2;
 ...
 * <ul>
 *     <li>Создание нового клиента - {@link #createNewClient(CreateClientRequestV2, BindingResult)}</li>
...
public class ClientsControllerV2 {
     ...
     */
    @PostMapping
    public ResponseEntity<CreateClientResponse> createNewClient(@RequestBody @Valid CreateClientRequestV2 createClientRequest,
        ...
        if (bindingResult.hasErrors()) {
            ...
            throw new CreateClientError(HttpStatus.UNPROCESSABLE_ENTITY, errorMessage.substring(0, errorMessage.length() - 2));
        }
